...
This chapter presents the testing methodology, the hardware specifications used, and the comparative performance analysis of the three 
implemented algorithms: Brute Force, Greedy (Nearest Neighbor), and Held-Karp.

%% 1. Construction of the Test Set %%
\subsection{Construction of the Test Set}
\label{subsec:tests}
% TODO: Description of the methodology for constructing the test set used for validation.
...
\begin{table}[H]
    \centering
    \caption{Execution times measured on various tests.}
...
\begin{table}[H]
    \centering
    \caption{Comparison of costs and relative errors.} 
    \label{tab:accuracy}
    \begin{tabular}{|l|r|r|r|l|}
        ...
        Test 01 & 1,273,944 & 2,280,130 & \textbf{78.98\%} & Very Poor \\
        \hline
        Test 05 & 3,411,545 & $\infty$ (INF) & N/A & \textbf{Greedy Failed} \\
        Test 11 & 5,050,651 & $\infty$ (INF) & N/A & \textbf{Greedy Failed} \\
        Test 24 & 2,721,940 & $\infty$ (INF) & N/A & \textbf{Greedy Failed} \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|l|}
        \hline
        \textbf{Algorithm} & \textbf{Limit Reached} & \textbf{Cause} & \textbf{Impact} \\
        \hline
        Brute Force & $N \ge 13$ & Complexity $O(N!)$ & Timeout (Time) \\
        Held-Karp   & $N > 22$ (est.) & Memory $O(N 2^N)$ & Out of Memory \\
        Greedy      & Random & Graph Topology & \textbf{Solution Failure (Deadlock)} \\
        \hline
    \end{tabular}
\end{table}
